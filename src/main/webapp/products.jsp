    ...
    <div class="main-card mb-3 card mainCart">
      ...
      <form class="row p-3" id="product_add_form">
        ...
        <div class="btn-group col-md-3 " role="group">
          ...
          <button onclick="fncReset()" class="btn btn-outline-primary">Temizle</button>
        </div>
      </form>
    </div>
          ...
          <div class="modal-body">
            <div class="row ">
              <div class="col-md-3 mb-3">
                ...
                <div style="color: black" id="pro_purchase_price" class="form-text"></div>
              </div>
              <div class="col-md-3 mb-3">
              ...
              <div class="col-md-3 mb-3">
                ...
                <div style="color: black" id="pro_tax" class="form-text"></div>
              </div>
              <div class="col-md-3 mb-3">
