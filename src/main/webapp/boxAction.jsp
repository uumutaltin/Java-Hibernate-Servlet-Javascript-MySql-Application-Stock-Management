            ...
            <form class="row p-3" id="boxAction_add_form">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select id="pname"  class="selectpicker" data-width="100%" data-show-subtext="true" data-live-search="true">
                        ...
                        <option value="${item.pro_amount}" id="${item.pro_id}" data-subtext="<c:out value="${item.pro_detail}"></c:out>"><c:out value="${item.pro_title}"></c:out></option>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="text" min="1" max="100" name="bNo" id="bNo" class="form-control" disabled="disabled"/>
                </div>
