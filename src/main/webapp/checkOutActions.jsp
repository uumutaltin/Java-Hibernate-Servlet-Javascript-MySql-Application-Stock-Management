...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <div class="row">
                ...
                <div class="card cardBackground1" id="card">
                    <div class="card-body">
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <h4><strong> <c:out value="${dbUtil.allCashIn()}"></c:out>₺ </strong></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card cardBackground2" id="card">
                    <div class="card-body">
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <h4><strong> <c:out value="${dbUtil.allCashOut()}"></c:out>₺ </strong></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <%
                int profit =( dbUtil.allCashIn() ) - ( dbUtil.allCashOut() );
            %>
