            ...
            >
              <div class="card-body d-flex flex-row justify-content-between" style="padding-bottom: .6rem;">
                ...
                <div class="card-right">
                  <div style="font-size: 1.8rem;font-weight: 700; color:#22AE78;"><span><c:out value="${dbUtil.allCustomer().size()}"></c:out></span></div>
                </div>
              </div>
            </div>
            <div class="card mb-3">
      ...
      <div class="col-sm-6">
          ...
          <div class="card-body">
            ...
            <div class="row space-5">
              <div class="col-sm-12 col-md-12" style="height: 20px;">
                ...
                <span style="color: black;"><b><c:out value="${dbUtil.allCashIn()}"></c:out>₺ </b></span>
              </div>
        ...
        <div class="card"
          ...
          <div class="card-body">
            ...
            <div class="row space-5">
              <div class="col-sm-12 col-md-12" style="height: 20px;">
                <span style="color: black;"><b><c:out value="${dbUtil.allProduct().size()}"></c:out></b></span>
                <small class="text-muted">çeşit</small>
                <span style="color: black;"><b> <c:out value="${dbUtil.totalProduct()}"></c:out>  </b> adet</span>
              </div>
              <div class="col-6 col-sm-6 col-md-6">
                <div>
                  <small class="text-muted">maliyet değeri</small>
                  <br>
                  <span class="ff-2 fs-14 bold" style="color: black;"><b> + <c:out value="${dbUtil.totalProductPurchase()}"></c:out> ₺ </b></span>
                </div>
              </div>
              <div class="col-6 col-sm-6 col-md-6">
                <div>
                  ...
                  <br>
                  <span class="ff-2 fs-14 bold" style="color: black;"><b> + <c:out value="${dbUtil.totalProductSale()}"></c:out> ₺ </b></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="table-responsive">
            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
              ...
              <tr role="row" class="odd">
                ...
                <td> <c:out value="${item.pro_id}"></c:out>   </td>
                <td> <c:out value="${item.pro_code}"></c:out> </td>
                <td> <c:out value="${item.pro_title}"></c:out> </td>
                <td> <c:out value="${item.pro_sale_price}"></c:out> ₺</td>
